if(NOT GUROBI_FOUND)
  # 硬编码查找头文件和链接库
  set(SEARCH_PATHS_FOR_HEADERS "$ENV{GUROBI_HOME}/include")
  set(SEARCH_PATHS_FOR_LIBRARIES "$ENV{GUROBI_HOME}/lib")

  find_path(GUROBI_INCLUDE_DIR gurobi_c++.h PATHS ${SEARCH_PATHS_FOR_HEADERS})
  find_library(
    GUROBI_C_LIBRARY
    NAMES libgurobi110.dylib
  ...
  set(GUROBI_LIBRARIES debug ${GUROBI_CXX_LIBRARY_DEBUG} optimized
                       ${GUROBI_CXX_LIBRARY_RELEASE} ${GUROBI_C_LIBRARY})
