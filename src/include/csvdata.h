...
class CSVData {
  public:
    ...
    void
    delete_row_if(std::function<bool(int, int, const std::string &)> cbFun);
    void delete_row_if(
        std::function<bool(int, int, const std::string &, void *cbData)> cbFun,
        void *cbData);
    void delete_row_if(
        std::function<bool(int, const std::vector<std::string> &, void *cbData)>
            cbFun,
        void *cbData);
    ...
    void convert_date_format(const std::string &old_format,
                             const std::string &new_format, int column);
    void convert_date_format(const std::string &old_format,
                             const std::string &new_format, int row,
                             int column);
  ...
  private:
    ...
    void _read_file(const std::string &filename,
                    std::vector<std::vector<std::string>> &target, int &cols);
